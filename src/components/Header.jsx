        ...
        <header className="">
            <div className="max-w-[1440px] max-h[900px] mx-auto flex justify-between items-center px-[40px] py-[34px]">
                <div className="flex items-center gap-8">
                    <NavLink to='/' className="font-['Playfair Display'] font-bold leading-[31.99px] text-2xl text-[#444444] hover:text-green-700">AR.CHI</NavLink>
                ...
                <nav className="flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-4">
                        <span className="text-gray-300">|</span>
                        <button type="button" className="text-gray-600 hover:text-green-700 cursor-pointer">
